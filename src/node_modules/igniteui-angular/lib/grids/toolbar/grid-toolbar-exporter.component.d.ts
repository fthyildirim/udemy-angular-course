...
export declare class IgxGridToolbarExporterComponent extends BaseToolbarDirective {
    protected toolbar: IgxGridToolbarComponent;
     ...
     */
    isExporting: boolean;
    constructor(toolbar: IgxGridToolbarComponent, excelExporter: IgxExcelExporterService, csvExporter: IgxCsvExporterService);
    export(type: 'excel' | 'csv', toggleRef?: IgxToggleDirective): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<IgxGridToolbarExporterComponent, [{ host: true; }, { optional: true; }, { optional: true; }]>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<IgxGridToolbarExporterComponent, "igx-grid-toolbar-exporter", never, { "exportCSV": "exportCSV"; "exportExcel": "exportExcel"; "filename": "filename"; }, { "exportStarted": "exportStarted"; "exportEnded": "exportEnded"; }, ["hasExcelAttr", "hasCSVAttr"], ["*", "[excelText],excel-text", "[csvText],csv-text"]>;
}

//# sourceMappingURL=grid-toolbar-exporter.component.d.ts.map