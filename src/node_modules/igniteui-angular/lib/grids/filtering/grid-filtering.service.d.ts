import { OnDestroy, NgModuleRef, ComponentFactoryResolver, ApplicationRef, Injector } from '@angular/core';
...
export declare class IgxFilteringService implements OnDestroy {
    ...
    constructor(_moduleRef: NgModuleRef<any>, iconService: IgxIconService, _overlayService: IgxOverlayService, _factoryResolver: ComponentFactoryResolver, _appRef: ApplicationRef, _injector: Injector);
    ngOnDestroy(): void;
    toggleFilterDropdown(element: any, column: any): void;
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<IgxFilteringService, never>;
    static ɵprov: ɵngcc0.ɵɵInjectableDeclaration<IgxFilteringService>;
}

//# sourceMappingURL=grid-filtering.service.d.ts.map