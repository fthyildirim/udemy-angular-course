...
export declare class IgxGridExcelStyleFilteringComponent implements OnDestroy {
    ...
    constructor(cdr: ChangeDetectorRef, element: ElementRef, platform: PlatformUtil, gridAPI?: GridBaseAPIService<IgxGridBaseDirective>);
    /**
     * @hidden @internal
     */
    ngOnDestroy(): void;
     ...
     * @hidden @internal
     */
    initialize(column: IgxColumnComponent, overlayService: IgxOverlayService): void;
    /**
     * @hidden @internal
     */
    onPin(): void;
