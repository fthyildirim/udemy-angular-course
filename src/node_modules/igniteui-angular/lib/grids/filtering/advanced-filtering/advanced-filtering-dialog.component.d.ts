...
export declare class IgxAdvancedFilteringDialogComponent implements AfterViewInit, OnDestroy {
     ...
     * @hidden @internal
     */
    get displayDensity(): import("../../../core/displayDensity").DisplayDensity;
    /**
     * @hidden @internal
     */
     ...
     * @hidden @internal
     */
    initialize(grid: IgxGridBaseDirective, overlayService: IgxOverlayService, overlayComponentId: string): void;
    /**
     * @hidden @internal
     */
    getFormatter(field: string): (value: any) => any;
    /**
     * @hidden @internal
     */
     ...
     * @hidden @internal
     */
    getTimezone(field: string): string;
    /**
     * @hidden @internal
     */
