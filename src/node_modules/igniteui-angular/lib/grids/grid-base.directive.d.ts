...
import { IgxGridSelectionService, GridSelectionRange } from './selection/selection.service';
...
export declare abstract class IgxGridBaseDirective extends DisplayDensityBase implements GridType, OnInit, DoCheck, OnDestroy, AfterContentInit, AfterViewInit {
    ...
    constructor(selectionService: IgxGridSelectionService, colResizingService: IgxColumnResizingService, gridAPI: GridBaseAPIService<IgxGridBaseDirective & GridType>, _transactions: TransactionService<Transaction, State>, elementRef: ElementRef, zone: NgZone, document: any, cdr: ChangeDetectorRef, resolver: ComponentFactoryResolver, differs: IterableDiffers, viewRef: ViewContainerRef, navigation: IgxGridNavigationService, filteringService: IgxFilteringService, overlayService: IgxOverlayService, summaryService: IgxGridSummaryService, _displayDensityOptions: IDisplayDensityOptions, localeId: string, platform: PlatformUtil);
    /**
     * @hidden
     * @internal
     */
     ...
     * @hidden @internal
     */
    isSummaryRecord(record: any): boolean;
    /**
     * @hidden
     * @internal
     */
     ...
     * @internal
     */
    get crudService(): import("./common/crud.service").IgxGridCRUDService;
    _setupServices(): void;
