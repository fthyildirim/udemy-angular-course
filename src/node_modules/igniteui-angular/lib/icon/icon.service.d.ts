 ...
 * ```
 */
export declare class IgxIconService implements OnDestroy {
    private _sanitizer;
    private _httpClient;
    private _document;
    /**
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<IgxIconService, [{ optional: true; }, { optional: true; }, { optional: true; }]>;
}
