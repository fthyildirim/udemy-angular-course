...
export declare class IgxDropDownComponent extends IgxDropDownBaseDirective implements IDropDownBase, OnChanges, AfterViewInit, OnDestroy {
    ...
    constructor(elementRef: ElementRef, cdr: ChangeDetectorRef, platform: PlatformUtil, selection: IgxSelectionAPIService, _displayDensityOptions: IDisplayDensityOptions);
    /**
     * Opens the dropdown
     *
     * ```typescript
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<IgxDropDownComponent, [null, null, null, null, { optional: true; }]>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<IgxDropDownComponent, "igx-drop-down", never, { "allowItemsFocus": "allowItemsFocus"; }, { "onOpening": "onOpening"; "onOpened": "onOpened"; "onClosing": "onClosing"; "onClosed": "onClosed"; }, ["virtDir", "children"], ["*"]>;
}
