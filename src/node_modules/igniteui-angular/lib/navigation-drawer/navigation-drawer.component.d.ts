...
export declare class IgxNavigationDrawerComponent implements IToggleView, OnInit, AfterContentInit, OnDestroy, OnChanges {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<IgxNavigationDrawerComponent, [null, { optional: true; }, null, null, null]>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<IgxNavigationDrawerComponent, "igx-nav-drawer", never, { "id": "id"; "position": "position"; "enableGestures": "enableGestures"; "pinThreshold": "pinThreshold"; "pin": "pin"; "width": "width"; "disableAnimation": "disableAnimation"; "miniWidth": "miniWidth"; "isOpen": "isOpen"; }, { "isOpenChange": "isOpenChange"; "pinChange": "pinChange"; "opening": "opening"; "opened": "opened"; "closing": "closing"; "closed": "closed"; }, ["miniTemplate", "contentTemplate"], never>;
}
