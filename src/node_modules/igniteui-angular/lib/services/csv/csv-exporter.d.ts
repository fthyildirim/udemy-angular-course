...
export declare class IgxCsvExporterService extends IgxBaseExporter {
    ...
    private _stringData;
    protected exportDataImplementation(data: IExportRecord[], options: IgxCsvExporterOptions): void;
    private saveFile;
    private exportFile;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<IgxCsvExporterService, never>;
    static ɵprov: ɵngcc0.ɵɵInjectableDeclaration<IgxCsvExporterService>;
}
